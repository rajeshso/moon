...
@InitiatingFlow
@StartableByRPC
class AgreeTowerRentalAgreementFlow(val linearId: UniqueIdentifier, val amount: Amount<Currency>): FlowLogic<SignedTransaction>() {
    @Suspendable
    override fun call(): SignedTransaction {
        ...
        val settleCommand = Command(TowerContract.Commands.AgreeTowerRentalAgreement(), listOf(counterparty.owningKey, ourIdentity.owningKey))
