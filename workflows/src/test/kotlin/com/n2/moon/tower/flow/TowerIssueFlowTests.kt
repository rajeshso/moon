...
class TowerIssueFlowTests {
     ...
     * TODO: Amend the [InstallTowerFlow] to verify the transaction as well as sign it.
    ...
    fun flowReturnsVerifiedPartiallySignedTransaction() {
        ...
        val futureOne = a.startFlow(InstallTowerFlow(zeroIou))
        mockNetwork.runNetwork()
        ...
        val futureTwo = a.startFlow(InstallTowerFlow(borrowerIsLenderIou))
        mockNetwork.runNetwork()
        assertFailsWith<TransactionVerificationException> { futureTwo.getOrThrow() }
        // Check a good TowerState passes.
        val towerState = TowerState(10.POUNDS, lender, borrower)
        val futureThree = a.startFlow(InstallTowerFlow(towerState))
        mockNetwork.runNetwork()
     ...
     * TODO: Amend the [InstallTowerFlow] to collect the [otherParty]'s signature.
     * Hint:
     ...
     * TODO: Amend the [InstallTowerFlow] by adding a call to [FinalityFlow].
     * Hint:
