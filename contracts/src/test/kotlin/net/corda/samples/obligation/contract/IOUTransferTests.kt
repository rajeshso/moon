...
class  IOUTransferTests {
    ...
    var ledgerServices = MockServices(listOf("net.corda.samples.obligation.contract", "net.corda.finance.contracts.asset", "com.n2.moon.tower.contracts",CashSchemaV1::class.packageName))
